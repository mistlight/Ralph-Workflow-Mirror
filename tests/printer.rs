//! Test printer for integration tests.
//!
//! This is a copy of the TestPrinter from ralph-workflow, but only
//! available to integration tests. This avoids polluting the library
//! with test-only code.
...
use ralph_workflow::json_parser::printer::Printable;
