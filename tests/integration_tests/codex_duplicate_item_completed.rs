...
"#;
        ...
        assert_eq!(
            lines.len(),
            1,
            "Expected exactly one output line in Basic mode. Output:\n{output}"
        );
        assert!(
        ...
        assert_eq!(
            prefix_count, 1,
            "Expected prefix to be printed once in Basic mode. Output:\n{output}"
        );
    });
}
...
"#;
        ...
        assert_eq!(
            lines.len(),
            1,
            "Expected exactly one output line in None mode. Output:\n{output}"
        );
        assert!(
            output.contains("[ccs/codex]"),
            "Expected prefix in output. Output:\n{output}"
        ...
        assert_eq!(
            prefix_count, 1,
            "Expected prefix to be printed once in None mode. Output:\n{output}"
        );
    });
}
