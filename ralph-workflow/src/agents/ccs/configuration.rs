...
///
/// Implementation note: We use conditional compilation to control visibility
/// (pub in test/test-utils, pub(crate) otherwise) but maintain a single definition.
...
/// Macro to define the ccs_env_var_debug_summary function with configurable visibility.
/// This eliminates duplication between test and production builds.
