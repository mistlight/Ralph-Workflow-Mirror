// AgentRegistry struct definition and core implementation.
// Contains: struct, new(), set_*, register, resolve_*, display_name,
// resolve_from_logfile_name, resolve_fuzzy, get_fuzzy_alternatives,
// list, developer_cmd, reviewer_cmd, load_from_file.
