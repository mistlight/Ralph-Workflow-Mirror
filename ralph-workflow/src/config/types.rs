...
pub struct FeatureFlags {
    ...
    /// Whether to enable automatic rebasing before/after pipeline
    pub(crate) auto_rebase: bool,
    /// Maximum number of recovery attempts during rebase conflict resolution
