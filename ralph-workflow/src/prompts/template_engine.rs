...
mod tests {
    ...
    fn test_render_template() {
        let template = Template::new("Hello {{NAME}}, your score is {{SCORE}}.".to_string());
    ...
    fn test_no_variables() {
        let template = Template::new("Just plain text.".to_string());
    ...
    fn test_whitespace_in_variables() {
        let template = Template::new("Value: {{ VALUE }}.".to_string());
    ...
    fn test_unclosed_opening_braces() {
        ...
        let template = Template::new("Hello {{NAME and some text".to_string());
        let rendered = template.render(&HashMap::new()).unwrap();
    ...
    fn test_empty_variable_name() {
        ...
        let template = Template::new("Value: {{}}.".to_string());
        let rendered = template.render(&HashMap::new()).unwrap();
    ...
    fn test_multiple_unclosed_braces() {
        ...
        let template = Template::new("{{A text {{B text".to_string());
        let rendered = template.render(&HashMap::new()).unwrap();
    ...
    fn test_partial_closing_brace() {
        ...
        let template = Template::new("Hello {{NAME}} and {{VAR}} text".to_string());
